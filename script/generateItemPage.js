...
/*const generateItemPage = ({ id, img: [img, secondImg], name, description, price }) => {
  ...
  if (location.pathname.includes('card') && location.hash) {
    ...
    getData.getItemById(itemId, ({
      ...
      const itemIsInstock = count ? {
        ...
        cssClass: "good-item not-in-stock",
        itemPrice: '<span class="good-item__empty">Нет в наличии</span>',
      }
      cardContainer.innerHTML = `
        <div class="breadcrumb">
          <nav role="navigation" aria-label="Breadcrumb" class="breadcrumb__nav">
            <ul class="breadcrumb__list">
              ...
              <li class="breadcrumb__list-item">
                <a href="goods.html?cat=${subcategory}" class="breadcrumb__link"><span>${subcategory}</span></a>
              </li>
              <li class="breadcrumb__list-item">
        ...
        <div class="good wrapper">
          ...
          <div class="good-images">
            ...
            <div class="good-image__item">
              <img src=${secondImg} alt=${name}>
            </div>
          </div>

          <div class=${itemIsInstock.cssClass}> <!-- not-in-stock - нет в наличии-->
